                        ...
                        <div className={`${style.contentIntro}`}>
                            ...
                            <p className='ml-2'>
                                <span className='text-sm' style={{ fontFamily: "Arial,Helvetica,sans-serif" }}>
                                    Có thể khẳn định một cách chắn chắn rằng trong lĩnh vực công nghệ số, tốc độ là yếu tố quyết định. Trong không gian số không hề có các giào cản hữu hình, mọi thứ rất bình đẳng. Chậm không chỉ bị thụt lùi còn đứng trước nguy cơ mất tất cả
                                </span>
                            </p>
